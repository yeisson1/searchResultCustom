...
const DepartmentFiltersCustom:any = DepartmentFilters
const AccordionFilterPriceRangeCustom:any = AccordionFilterPriceRange
...
const AccordionFilterContainer = ({
  ...
  const nonEmptyFilters = filters.filter((spec:any) => spec.facets.length > 0)
  ...
  return (
    ...
    >
      ...
      {nonEmptyFilters.map((filter:any) => {
        ...
        switch (type) {
          case 'PriceRanges':
            return (
              <AccordionFilterPriceRangeCustom
                title={filter.title}
